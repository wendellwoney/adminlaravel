...
<head>
    ...
    <title>{{\App\Config::SITE_NAME}} 503 - SERVIÇO INSDISPONÍVEL</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center mt-4">
                            ...
                            <p class="lead">SERVIÇO INSDISPONÍVEL</p>
                            <p>Serviço indisponível consulte o administrador do sistema.</p>
